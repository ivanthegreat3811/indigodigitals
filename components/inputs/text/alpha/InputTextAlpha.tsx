...
import defaultStyleSheet from './InputTextAlphaCSS/InputTextAlpha.module.css';

export interface IInputTextAlpha {
  style?: CSSProperties;
  className?: string;
  isFocus?: boolean;
  fieldName?: string;
...
const InputTextAlpha: React.FC<IInputTextAlpha> = ({ style, className, isFocus, fieldName, isRequired = false }) => {
