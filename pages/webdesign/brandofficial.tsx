...
const brandOfficailWebsite: NextPageWithLayout = () => {
  useEffect(() => {
  ...
  return (
    <div>
      <div className={styleSheet.carouselWrapper}>
        <div className={styleSheet.carouselContainer}>Main View</div>
      </div>
      <main>
        <section>
          <div>
...
export default brandOfficailWebsite;

brandOfficailWebsite.getLayout = page => <PrimaryLayout>{page}</PrimaryLayout>;
